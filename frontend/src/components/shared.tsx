...
export function SummaryPill({
  ...
  return (
    <div className="flex min-h-[58px] items-center gap-2.5 rounded-[14px] bg-[#eef3e9] p-2.5 text-[#24352c]">
      {icon}
      <div>
        <span className="block text-[0.78rem] font-semibold text-[#637061]">{label}</span>
        <strong className="block text-[1rem] font-bold capitalize leading-[1.15]">{value}</strong>
      </div>
    </div>
  );
}
